...
const Hero = () => {
  ...
  return (
    <section id="hero" className="flex flex-col justify-end items-center mb-32 lg:px-30 px-8 cursor-default">
      ...
      <div className='lg:leading-[55vh] leading-23 my-5 lg:my-0 justify-center flex flex-col items-center'>
        <h3 ref={mayurRef} className="dm-sans text-black text-[22vw] lg:text-[15rem] fw-700 lg:-mb-34 lg:mt-[32vh] ">
        Mayur
      </h3>
      <h3 ref={kumawatRef} className="dm-sans text-[20.5vw] lg:text-[15rem] font-normal text-(--primery-color) lg:-mb-12 italic">
        Kumawat
      </h3>
      </div>
