...
const Testimonials = () => {
  return (
    <section className='py-10 bg-grid2 p-8'>
      ...
      <div note="carousel component" className=' relative flex flex-col lg:flex-row gap-5 py-10 '>
        <div className='hidden absolute py-10 left-0 top-0 w-full h-full lg:flex justify-between items-center pointer-events-none'>
